...
public class Accesses {
    ...
    public static <T, ID> Access<T, ID> of(Class<T> entityType, Query query, UpdateExecutor update, Metamodel metamodel) {
        return new AccessImpl<>(entityType, query, update, metamodel);
    }

    public static <T, ID extends Serializable> Access<T, ID> of(DependencyDescriptor descriptor, Query query, UpdateExecutor update, Metamodel metamodel) {
    ...
    static class AccessImpl<T, ID> extends AccessFacade<T, ID> implements Access<T, ID> {
        public AccessImpl(Class<T> entityType, Query query, UpdateExecutor update, Metamodel metamodel) {
